...
DEFAULT_SCREEN_SIZE = SCREEN_SIZE
...
# OPTIONS MENU
OPTIONS_MENU_SIZE = SCREEN_WIDTH / 3, SCREEN_HEIGHT / 3

# Inventory
class INVENTORY:
    FULL_SIZE = (SCREEN_WIDTH / 2.2, SCREEN_HEIGHT / 2.25)
...
def get_zoom():
    dw, dh = DEFAULT_SCREEN_SIZE
    sw, sh = SCREEN_SIZE

    return (sh / dh) * DEFAULT_ZOOM
...
PLAYER_SKILL_POINTS_PER_UPGRADE = 1
...
def update_constants():
    global SCREEN_SIZE, SCREEN_CENTER, SCREEN_MARGIN
    global PLAYER_HEALTH_BAR_WIDTH, PLAYER_HEALTH_BAR_HEIGHT, PLAYER_XP_BAR_HEIGHT, PLAYER_XP_BAR_WIDTH
    global PLAYER_NAME_AND_LEVEL_LABEL_WIDTH, PLAYER_NAME_AND_LEVEL_LABEL_HEIGHT, ENEMY_INFO_SIZE, PANEL_BORDER_SIZE
    global FPS_INFO_SIZE, CAMERA_SIZE, ZOOM, PLAYER_UI_SPACING, OPTIONS_MENU_SIZE
    ...
    # Inventory
    INVENTORY.FULL_SIZE = (SCREEN_WIDTH / 2.2, SCREEN_HEIGHT / 2.25)
    INVENTORY.TITLE_HEIGHT_IN_PERC = 0.1
    INVENTORY.DISPLAY_SIZE = (INVENTORY.FULL_SIZE[0], INVENTORY.FULL_SIZE[1] * (1 - INVENTORY.TITLE_HEIGHT_IN_PERC))
    INVENTORY.ITEM_DESPLAY_WIDTH = INVENTORY.DISPLAY_SIZE[0] * 0.6
    INVENTORY.ITEM_DESPLAY_HEIGHT = INVENTORY.DISPLAY_SIZE[0] * 0.075
    INVENTORY.MAIN_RECT_CENTER = SCREEN_CENTER[0] + INVENTORY.FULL_SIZE[0] / 3 , SCREEN_CENTER[1]

    # Stats Display
    STATS_DISPLAY.FULL_SIZE = (SCREEN_WIDTH - INVENTORY.FULL_SIZE[0]) / 2, INVENTORY.FULL_SIZE[1]
    ...
    # Misc
    FPS_INFO_SIZE = (16 * ZOOM, 16 * ZOOM)
    PLAYER_UI_SPACING = ZOOM / 2
